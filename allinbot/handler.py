...
class Handler:
    ...
    def can_handle_message(self, message: discord.Message) -> bool:
        ...
        function return true if and only if this is the case.
    ...
    async def handle_message(self, client: discord.Client, message: discord.Message):
        ...
        with appropriately. The handler should then return an Awaitable bool representing whether the message was
